...
├── pc2_kplanner_onnx.py         # torch-free planner runtime (ONNX + dances)
...
└── planner_stack/
    ...
    └── models/
        ├── planner_onnx/x2_planner_{template,velocity}.onnx + README + parity_report
        ├── dances_x2m2/*.x2m2   # 14 baked easy dances
        ├── kplanner/            # raw ckpts (vqvae 250k synced; NOT used at runtime)
