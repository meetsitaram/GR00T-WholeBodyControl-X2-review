...
PC2 host/user defaults are `run@10.0.1.41`; override with
...
import time
c = ComposedCameraClientSensor(server_ip='10.0.1.41', port=5555)
t0 = time.time(); n = 0
...
```
[recorder] head cameras ENABLED -> connecting to tcp://10.0.1.41:5555
