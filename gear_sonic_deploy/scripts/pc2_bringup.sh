...
# (/home/run/getsolo by default) so the system Python, system /opt, and the
# AgiBot /agibot/software tree are all left untouched.
#
# Layout produced under ${PC2_PREFIX} (default /home/run/getsolo):
#
...
#     pc2_bringup.sh --pc2-host 10.0.1.41 --prefix /home/run/getsolo
#
# Flags:
#     --pc2-host HOST            default: 10.0.1.41 (or env PC2_HOST)
#     --pc2-user USER            default: run       (or env PC2_USER)
#     --prefix PATH              default: /home/run/getsolo (PC2 side)
