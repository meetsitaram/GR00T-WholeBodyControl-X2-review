"""
Side-loadable Isaac-GR00T modality config for X2 Ultra (7-DOF hand variant).
...
``--embodiment-tag NEW_EMBODIMENT``:
    ...
    python gr00t/experiment/launch_finetune.py \\
        ...
        --embodiment-tag NEW_EMBODIMENT \\
        --modality-config-path gear_sonic/data/x2_modality_config_7dof.py

The 7-DOF hand layout matches Isaac-GR00T's ``unitree_g1_sonic`` posttrain
embodiment, which lets us share evaluation infrastructure and replay the
same dataset against the upstream G1 SONIC checkpoint for cross-embodiment
ablations.
"""
...
X2_MODALITY_CONFIG_7DOF = make_x2_modality_config(hand_dof=7)

register_modality_config(
    X2_MODALITY_CONFIG_7DOF,
